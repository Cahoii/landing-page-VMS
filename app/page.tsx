          ...
          <div className="mx-auto max-w-4xl">
            <div className="text-center px-0 leading-5">
              <h1 className="mb-8 text-balance text-5xl tracking-tight text-white [text-shadow:_0_4px_20px_rgb(0_0_0_/_60%)] md:text-6xl lg:text-8xl">
                <span className="font-open-sans-custom not-italic">Visual.</span>{" "}
                <span className="font-serif italic">Math.</span>{" "}
                <span className="font-open-sans-custom not-italic">Studio.</span>
              </h1>
              ...
              <div className="flex justify-center">
                <ShinyButton className="px-8 py-3 text-base">Download</ShinyButton>
              </div>
            </div>
          </div>
        </section>
